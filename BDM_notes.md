...
- **Trade Creates Value**
    ...
    > to visualize
    >    - ![sq representation](image-2.png)
    >    - ![producers(both states) to consumers(both states)](image-3.png)
    ...
    >   - ![some calrifiaciton](image-4.png)
...
---
# Week 2 - sourcing of data.
- govt does have a big role to play in the data gathering, due to its place in the circular flow model.
    - ![role of gvt in data collection](image-11.png) 
    - The Population Census is conducted every 10 years. It collects detailed information about every household and individual in the country.
    - The Economic Census also covers the whole country but focuses  on households and establishments involved in economic activities alike, like running a business or providing services. It helps understand India's economic structure at the grassroots level.
    - the same thing happens for the annual survey of industries (ASI) is a yearly, sample-based survey that provides detailed data particularly on sampled registered factories in India, covering aspects like production, employment, and wages, it also gives info about the GVA - Gross Value Added i.e the sole value of a product subtracting the production cost of the product from the factory sector.
    - the NSS also works in the similar manner as ASI, but in context of soley of a few sampled households from India.
    - ![other govt data sources](image-12.png)
    - liscense data inclues all the kinds of liscenses issued, be it driving liscense or selling liscense.
    - WPI and CPI give data about Wholesale Price Index and Consumer Price Index, which can be analysed to see the inflation happening in the markets. 
    - RTI means that they'll make all the data they have publicaly available. 
    - PLFS gives data about un/employment of the masses 
- now we move on to the non-govt data sources, this comes from CIME -   Centre for Monetering Indian Economy(was found on 13th april 1976).
    - ![CIME](image-13.png)
    - in  ***consumer pyramids of household survey***
        - a **longitudinal survey** means the same household being surveyed again and again, as sometimes the iid samples may not help in analyse how the movement of a household changes.
        - **homogenous regions** remove the biases, as an iid smapling in the groups of household(based on thier expenditure) may yeild a biased survey result.

- there is some data manipulation to be learnt using excel, since i don't have the data which they're using, ill use one of the dataset that i have available.
    - ### Applying a column filter in excel:
        - ```excel
            Home -> editing -> sort and filter.
          ```
        - applies a filter on the columns like shown below:
        ![filter on colns](image-14.png)

        - [great videos on gaining some beautiful insights from data pt 1](https://youtu.be/RY_GT1D-Xd4)
        - [great videos on gaining some beautiful insights from data pt 2](https://youtu.be/FnTWRahScGk)
